...
int TodosOuUmLista()
{
    ...
    {
        limparTela();
        printf("Deseja listar todos ou apenas um especifico?\n1. Todos\n2. Especifico\n\n");
        scanf("%d", &op);
        limparTela();
        if (op == 1)
        {
...

{
    ...
    if (Nlocal < 1)
    {
        printf("nao existem locais! adicione um local!\n");
    }
    else
    {
        for (int i = 0; i < Nlocal; i++)
...
void excluiLocal()
{
    ...
    while (op < 1 || op > Nlocal)
    {
        limparTela();
        listaNomesLocal();
        printf("Digite um numero entre 1 e %d : ", Nlocal);
        scanf("%d", &op);
        if (op > Nlocal || op < 1)
        {
            mensagemErro(-1);
...
void excluiCat()
{
    ...
    while (op < 1 || op > NCat)
    {
        limparTela();
        listaNomesCategoria();
        printf("Digite um numero entre 1 e %d : ", NCat);
        scanf("%d", &op);
        if (op > NCat || op < 1)
        {
            mensagemErro(-1);
